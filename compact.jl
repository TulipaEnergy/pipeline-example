...
# ╔═╡ f986ea30-6741-4cbd-a16b-b54ea4e408c3
md"""
---
...
- assets-data.csv and flows-data.csv for the graph part
- profiles.csv with all the profiles
- assets-profiles.csv and flows-profiles.csv to link to the profiles

No timeframe profiles are used.
Hourly resolution used by default.
"""
...
# ╔═╡ 2b9eb07a-43aa-4f7e-bf77-0aee7317fb65
begin
	preparation_complete

	# Read the data
	con = DBInterface.connect(DDB.DB)
	TIO.read_csv_folder(con, "data")

	# Cluster profiles
	period_duration = 24
	num_rep_periods = 5
	tc_df = TIO.get_table(con, "profiles")
	...
	TC.write_clustering_result_to_tables(con, clustering_result)

	# Model
	energy_problem = TEM.EnergyProblem(con)
...
manifest_format = "2.0"
project_hash = "afb58e2bc64ee02161401f7397fa79030ddc9ce4"
